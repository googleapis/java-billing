...
[google-cloud-java/java-billing](
https://github.com/googleapis/google-cloud-java/tree/main/java-billing).
This repository will be archived in the future.
Future releases will appear in the new repository (https://github.com/googleapis/google-cloud-java/releases).
The Maven artifact coordinates (`com.google.cloud:google-cloud-billing`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-billing:2.13.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-billing" % "2.13.0"
```
...
The client application making API calls must be granted [authorization scopes][auth-scopes] required for the desired Cloud Billing APIs, and the authenticated principal must have the [IAM role(s)][predefined-iam-roles] required to access GCP resources using the Cloud Billing API calls.
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-billing/latest/history
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-billing/2.13.0
