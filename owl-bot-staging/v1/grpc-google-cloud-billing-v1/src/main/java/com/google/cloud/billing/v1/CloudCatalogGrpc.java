...
public final class CloudCatalogGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.billing.v1.ListServicesRequest,
      com.google.cloud.billing.v1.ListServicesResponse> getListServicesMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.billing.v1.ListServicesRequest,
      com.google.cloud.billing.v1.ListServicesResponse> getListServicesMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.billing.v1.ListServicesRequest, com.google.cloud.billing.v1.ListServicesResponse> getListServicesMethod;
      ...
      synchronized (CloudCatalogGrpc.class) {
        if ((getListServicesMethod = CloudCatalogGrpc.getListServicesMethod) == null) {
          CloudCatalogGrpc.getListServicesMethod = getListServicesMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.billing.v1.ListServicesRequest, com.google.cloud.billing.v1.ListServicesResponse>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.billing.v1.ListSkusRequest,
      com.google.cloud.billing.v1.ListSkusResponse> getListSkusMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.billing.v1.ListSkusRequest,
      com.google.cloud.billing.v1.ListSkusResponse> getListSkusMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.billing.v1.ListSkusRequest, com.google.cloud.billing.v1.ListSkusResponse> getListSkusMethod;
    if ((getListSkusMethod = CloudCatalogGrpc.getListSkusMethod) == null) {
      synchronized (CloudCatalogGrpc.class) {
        if ((getListSkusMethod = CloudCatalogGrpc.getListSkusMethod) == null) {
          CloudCatalogGrpc.getListSkusMethod = getListSkusMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.billing.v1.ListSkusRequest, com.google.cloud.billing.v1.ListSkusResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class CloudCatalogImplBase implements io.grpc.BindableService {
    ...
    public void listServices(com.google.cloud.billing.v1.ListServicesRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.billing.v1.ListServicesResponse> responseObserver) {
    ...
    public void listSkus(com.google.cloud.billing.v1.ListSkusRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.billing.v1.ListSkusResponse> responseObserver) {
   ...
   * </pre>
   */
  public static final class CloudCatalogStub extends io.grpc.stub.AbstractAsyncStub<CloudCatalogStub> {
   ...
   * </pre>
   */
  public static final class CloudCatalogBlockingStub extends io.grpc.stub.AbstractBlockingStub<CloudCatalogBlockingStub> {
   ...
   * </pre>
   */
  public static final class CloudCatalogFutureStub extends io.grpc.stub.AbstractFutureStub<CloudCatalogFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.billing.v1.ListServicesResponse> listServices(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.billing.v1.ListSkusResponse> listSkus(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_SERVICES:
          serviceImpl.listServices((com.google.cloud.billing.v1.ListServicesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.billing.v1.ListServicesResponse>) responseObserver);
          break;
        case METHODID_LIST_SKUS:
          serviceImpl.listSkus((com.google.cloud.billing.v1.ListSkusRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.billing.v1.ListSkusResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CloudCatalogBaseDescriptorSupplier
